        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="pilihanjenis_beasiswa.php">JENIS BEASISWA</a>
                    </li>
                    <li class="nav-item">
                    ...
                    ?>
                        ...
                        <td class="text-center">
                            <form action="verifikasi.php?id=<?php echo $data['id']; ?>" method="POST">
                                ...
                                <button class="btn btn-primary m-2" type="submit"style="background-color: #B70404;">Submit</button>
                            </form>
                        </td>
                </tr>
            <?php
